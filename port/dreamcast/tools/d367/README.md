...
```
LH="NO_EH=1 NATIVE_ACTOR=1 NATIVE_ACTOR_FAST=1 NATIVE_ACTOR_SKIN=1 PVR_FAST_WAKE=1 BRIDGE_LEAN=1 PVR_PIPELINE=2 MESH_LOD=1 MESH_LOD_PX=3 NATIVE_FOG=1 COPY_LEAN=1 FRONT_LEAN=1 MESH_DIRECT=1 TA_DIRECT=1 NATIVE_ACTOR_DIRECT=1 UI_VRAM=1 TA_VERTBUF_KB=2048 GAME_FP_CONTRACT=off GAME_CPU=1 GAME_ROT_CACHE=1 GAME_O2=hot GAME_TRIG=1 GAME_PWC_DIAG=1 GAME_ATCHK=1 GAME_MOTION_INDEX=1 GAME_CONCAT_COL=1 GAME_SINCOS=1 GAME_MULTVEC_SCHED=1 GAME_VEC_INLINE=1 GAME_COL_PREFETCH=1 GAME_ATCHK_LIST=1 AICA_AUDIO=1 RELEASE_FLAGS=1"
