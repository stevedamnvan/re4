...
M1="ROUTE_MOVIES=1 AICA_STREAMS=1 SUBSCREEN=1 UI_HANDLES=1 TEX_RESIDENT=1 FX_LEAN=1 EM10_SHARED=1 ARENA_FIT=1 GAME_COLD_OS=1 SOUND_REGION_BYTES=0x60000 MOTION_FAST_READ=1 NATIVE_ACTOR_SKIN_LAZY=1 QUALITY=1 VMU_SAVE=1 VMU_DEBUG_SLOT=1 NATIVE_MES=1"
