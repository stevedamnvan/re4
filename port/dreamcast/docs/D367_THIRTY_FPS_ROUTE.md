...
- **Current order (user, 2026-09-25):** (1) land the coarse renderer with frame pacing (done: f4da5fd), (2) R headroom
  ...
  block walk kernels GAME_LINE_LEAF, cf46edc, and GAME_LINE_WALK, ba73027, all exact: **G_q 30.94**, gap 5.97; the
  pieces' transforms and the sphere queries next), then visual simulation once its gameplay readers are
  known; appearance (step 5) after G.
