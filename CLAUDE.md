...
2026-09-25: the r101 square (30 fps rethink) follows [D367_SQUARE_PERF_PLAN.md](port/dreamcast/docs/D367_SQUARE_PERF_PLAN.md), section "Current order and status". Frame pacing and the coarse renderer landed default off (f4da5fd); R headroom and code placement (LINK_ORDER) landed default off (801d72d); the em-em candidate cache GAME_ATCHK_CACHE landed default off (aeefd26): G_q 32.23, R ~4. Next: G (collision traversal: the line queries; then visual simulation).
